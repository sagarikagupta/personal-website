...
const Navbar = () => {
    ...
    return (
        <div className={`navbar fixed top-0 left-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-black' : 'bg-gradient-to-r from-gray to-gray'} text-primary-content`}>
